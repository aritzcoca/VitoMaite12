        ...
        aficionesUsuariosStore.openCursor().onsuccess = function (event) {
            ...
            if (cursor) {
                ...
                aficionesStore.getAll().onsuccess = function (event) {
                    ...
                    // Filtrar aficiones que no tiene el usuario
...
function generarCheckboxes(containerId, aficionesIds, todasLasAficiones, titulo) {
    ...
    // Crear checkboxes para cada afición
    aficionesIds.forEach((aficionId) => {
        ...
        if (aficion) {
            ...
            checkbox.name = containerId; // Asignar un nombre relacionado con el contenedor
...
*/
//////////////////////////////HASTA AQUI HACE BIEN (MUESTRA SEPARADAS LAS AFICIONES QUE TIENE Y LAS QUE NO/////////////////////////////////////
